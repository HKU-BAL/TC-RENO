...
from pre_round3 import read_bigg, bigg_count_write,write_bigg, bigglist_to_bedfile
import collections
from collections import OrderedDict
import os
from pre_cluster_round3 import *
    ...
    try:
        ...
        try:
            while n < n_count and len(bigg_nano) > batchsize:
                ...
                _, bigg_list_by1 = flow_cluster(bigg_1,  intronweight=intronweight)
                bigg_nano = add_subread_bigg(bigg_list_by1 + bigg_2)
                n += 1
#            print 'a',bigg_nano
            D, bigg_nano_new = flow_cluster(bigg_nano, intronweight=intronweight)
