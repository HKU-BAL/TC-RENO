...
def bigglist_to_bedfile(bigg_list,prefix=None, dir='/mnt/bal19/qhli/RNA/tmp/'):
...
def wrapper_bedtools_intersect3(bedfile1,bedfile2,outfile=None):
    ...
    if outfile is None:
        ...
        location='//mnt/bal19/qhli/RNA/tmp/'

        outfile="/mnt/bal19/qhli/RNA/tmp/"+"_".join([prefix1, prefix2])+".bed"
